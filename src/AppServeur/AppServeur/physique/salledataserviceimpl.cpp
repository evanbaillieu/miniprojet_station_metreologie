...
{
    Salle newSalle;
    query.prepare("INSERT INTO salle (x_ini, y_ini, x_fin, y_fin, numSalle, nomSalle, nomAtelier) VALUES (:x_ini, :y_ini, :x_fin, :y_fin, :numSalle, :nomSalle, :nomAtelier)");
