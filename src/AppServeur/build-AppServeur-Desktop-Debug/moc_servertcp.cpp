...
#include "../AppServeur/client/servertcp.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ServerTCP_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ServerTCP_t qt_meta_stringdata_ServerTCP = {
    {
QT_MOC_LITERAL(0, 0, 9), // "ServerTCP"
QT_MOC_LITERAL(1, 10, 3), // "fin"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 11), // "deconnexion"
QT_MOC_LITERAL(4, 27, 9), // "connexion"
QT_MOC_LITERAL(5, 37, 10) // "readClient"

    },
    "ServerTCP\0fin\0\0deconnexion\0connexion\0"
    "readClient"
};
...
void ServerTCP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ServerTCP::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ServerTCP::fin)) {
                *result = 0;
            }
        }
    }
...
void *ServerTCP::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ServerTCP.stringdata))
